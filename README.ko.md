...
기술적 지표와 차트 형태가 익숙하지 않다면 앱 실행 후 `/learn` 페이지를 열어보세요. EMA, VWAP, RSI, MACD, Bollinger Bands, ATR, 상대 거래량, OBV, 지지/저항, 하이킨아시, 손절, risk/reward, 헤드앤숄더, 플래그, 페넌트, 삼각수렴, 쐐기, 쌍봉/쌍바닥을 초보자 친화적으로 설명합니다.
