...
export function buildTradingSystemPrompt(locale: AppLocale = "ko"): string {
  ...
  return [
    ...
    "You may explain long/short/neutral bias, confidence, indicators, candlestick/chart patterns, invalidation, targets, option strategy helper ideas, and risk considerations.",
